...
export function ElasticGallery() {
  const items = [
    {
      ...
      title: "Pentas Seni",
      category: "Musik",
      src: "https://images.unsplash.com/photo-1549490349-8643362247b5?q=80&w=800",
      alt: "Pentas Seni",
    },
    {
      id: "02",
  ...
  return (
    <div className="w-full">
      ...
      <div className="mx-auto flex h-[500px] w-full max-w-6xl flex-col gap-2 md:h-[600px] md:flex-row md:gap-4">
        {items.map((item) => (
          <div
            key={item.id}
            ...
            className={cn(
              "relative cursor-pointer overflow-hidden rounded-2xl border border-neutral-200 bg-white dark:border-surface-muted/50 dark:bg-surface-muted",
