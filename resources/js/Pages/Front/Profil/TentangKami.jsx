...
export default function TentangKami() {
    return (
        <FrontLayout title="Tentang Kami">
            <div className="pt-28 pb-20 min-h-screen bg-gray-50 dark:bg-surface-base text-slate-800 dark:text-slate-200">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mt-8 mb-10">
                        ...
                        <span>&gt;</span>
                        <span className="font-semibold text-slate-800 dark:text-slate-200">Tentang Kami</span>
                    </div>
                    ...
                    <div className="mb-10">
                        ...
                        <p className="text-lg text-slate-600 dark:text-slate-400 max-w-3xl">
                            Informasi mengenai visi, misi, dan latar belakang berdirinya Unit Kegiatan Mahasiswa (UKM) Fakultas Teknik Blue Murder.
                        </p>
                    </div>
